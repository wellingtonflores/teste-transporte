...
// Percorre cada entrega existente no array '$entregas'.
foreach ($entregas as $entrega => $km) {
    ...
    if ($litros_necessarios <= $combustivel_inicial) {
        ...
        $entregas_sem_reabastecer[] = $entrega;
    }
...
echo "1) Entregas que podem ser realizadas sem reabastecer: ";
print_r($entregas_sem_reabastecer);

// Pergunta 2:
// Exibe quantos litros a mais seriam necessários para completar TODAS as entregas.
echo "2) Litros adicionais necessários para completar todas as entregas: " . $litros_adicionais_necessarios . "\n";